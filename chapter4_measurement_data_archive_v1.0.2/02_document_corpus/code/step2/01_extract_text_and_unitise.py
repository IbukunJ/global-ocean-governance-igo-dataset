...
Input:
  - data/processed/ch04_s2_executable_document_manifest.csv
  - data/raw/igo_documents/*.pdf

Outputs:
  - data/interim/ch04_s2_corpus_pages_2435.csv.gz
  - data/interim/ch04_s2_corpus_paragraphs_5159.csv.gz
...
MANIFEST = ROOT / "data" / "processed" / "ch04_s2_executable_document_manifest.csv"
OUT_PAGES = ROOT / "data" / "interim" / "ch04_s2_corpus_pages_2435.csv.gz"
OUT_PARAS = ROOT / "data" / "interim" / "ch04_s2_corpus_paragraphs_5159.csv.gz"
OUT_LOG = ROOT / "data" / "interim" / "ch04_s2_extraction_log_130.csv"
